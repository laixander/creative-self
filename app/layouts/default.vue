...
const allNavItems = computed<NavigationMenuItem[]>(() => [
    ...
    { label: 'Search Offerings', icon: 'i-lucide-search', to: '/hr/offerings' },
    { label: 'Providers', icon: 'i-lucide-briefcase', to: '/hr/providers' },
    { label: 'Bookings', icon: 'i-lucide-calendar', to: '/hr/bookings' },
    { label: 'Availed Services', icon: 'i-lucide-check-circle', to: '/hr/availed' },
    { label: 'Media / Feed', icon: 'i-lucide-image', to: '/hr/media' },
    { label: 'Company Profile', icon: 'i-lucide-building', to: '/hr/profile' },
